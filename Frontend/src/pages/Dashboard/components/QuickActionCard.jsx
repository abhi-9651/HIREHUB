...
function QuickActionCard({ title, description, to, state, icon: Icon, accent = 'purple' }) {
  const cyan = accent === 'cyan'

  return (
    <Link to={to} state={state} className="group block rounded-2xl outline-none focus-visible:ring-2 focus-visible:ring-[#06B6D4] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0F172A]">
